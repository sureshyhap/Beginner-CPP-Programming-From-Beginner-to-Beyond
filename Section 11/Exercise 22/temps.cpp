...
double fahrenheit_to_celsius(double f_temperature);
double fahrenheit_to_kelvin(double f_temperature);
...
double fahrenheit_to_celsius(double f_temperature) {
  return round((5.0 / 9.0) * (f_temperature - 32));
}

double fahrenheit_to_kelvin(double f_temperature) {
  return round((5.0 / 9.0) * (f_temperature - 32) + 273);
}
