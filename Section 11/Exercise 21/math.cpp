...
void c_math_functions() {
    ...
    double individual_bill_3_temp = individual_bill * 100;
    individual_bill_3_temp = ceil(individual_bill_3_temp);
    double individual_bill_3 = individual_bill_3_temp / 100;
