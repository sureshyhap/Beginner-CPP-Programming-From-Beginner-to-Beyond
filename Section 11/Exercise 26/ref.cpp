...
string print_guest_list(const std::string& guest_1, const std::string& guest_2, const std::string& guest_3);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
void clear_guest_list(std::string& guest_1, std::string& guest_2, std::string& guest_3);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
